...
class _MainScreenState extends ConsumerState<MainScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final currentFilters = ref.watch(eventFiltersProvider);
      ref.read(eventsNotifierProvider).loadEvents(filters: currentFilters);
    });
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: DesignTokens.purpleAccent.withValues(
                            alpha: 0.2,
                          ),
          ...
          if (isLoading)
            Container(
              color: DesignTokens.deepSpaceBlack.withValues(alpha: 0.9),
              child: Center(
                child: GlassPanel(
      ...
      child: Row(
        ...
        children: [
          Icon(
            Icons.circle,
            size: 8,
            color: DesignTokens.lightGray.withValues(alpha: 0.6),
          ),
          const SizedBox(width: 6),
          Text(
            '$eventCount events',
  ...
  void _onFiltersChanged(EventFilters newFilters) {
    ...
    ref.read(eventFiltersProvider);
    // Reload events with new filters
    ref.read(eventsNotifierProvider).loadEvents(filters: newFilters);
  }
  ...
  bool _isUsingMockData(WidgetRef ref) {
    // For now, always show mock indicator in development
            ...
            children: [
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  ...
                  overlayColor: DesignTokens.purpleAccent.withValues(
                    alpha: 0.3,
                  ),
                ...
                child: Slider(
                  ...
                  onChanged: (value) {
                    onFiltersChanged(
                      filters.copyWith(minSeverity: value.toInt()),
                    );
                  },
                ),
              ),
        ...
        children: [
          ...
          Text(
            ...
            style: AppTypography.body.copyWith(
              ...
              fontWeight: value ? DesignTokens.medium : DesignTokens.normal,
            ),
          ),
        ],
      ),
...
/// Event Marker Widget - Exact Next.js implementation
class EventMarker extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = DesignTokens.getCategoryColor(event.category.toString());
    final markerSize = size ?? (isSelected ? 20 : 12);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: isNew
            ? Icon(Icons.circle, size: markerSize * 0.4, color: Colors.white)
            : null,
      ),
    );
  }
