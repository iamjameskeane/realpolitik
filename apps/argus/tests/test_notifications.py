...
class TestNotificationFiltering:
    ...
    def test_severity_threshold(self, sample_event):
        ...
        # Default threshold is 1 (from config.py)
        PUSH_NOTIFICATION_THRESHOLD = 1
    ...
    def test_age_filtering(self, sample_event):
        ...
        # Default is 48 hours (from config.py)
        ...
        # Event from 100 hours ago (should fail if threshold is 48 hours)
...
class TestEventIdGeneration:
    ...
    def test_incident_id_deterministic(self):
        ...
        id1 = generate_incident_id("DIPLOMACY", 6.14, 46.20, "2024-01-01T12:00:00Z", 50.0)
        id2 = generate_incident_id("DIPLOMACY", 6.14, 46.20, "2024-01-01T12:00:00Z", 50.0)
    ...
    def test_incident_id_varies_by_category(self):
        ...
        id1 = generate_incident_id("DIPLOMACY", 6.14, 46.20, "2024-01-01T12:00:00Z", 50.0)
        id2 = generate_incident_id("MILITARY", 6.14, 46.20, "2024-01-01T12:00:00Z", 50.0)
    ...
    def test_incident_id_varies_by_location(self):
        ...
        id1 = generate_incident_id("DIPLOMACY", 6.14, 46.20, "2024-01-01T12:00:00Z", 50.0)
        id2 = generate_incident_id("DIPLOMACY", 100.0, 13.75, "2024-01-01T12:00:00Z", 50.0)
