...
class TestEventMerging:
    ...
    def test_generates_deterministic_incident_id(self):
        ...
        from argus.utils.hashing import generate_incident_id
        
        # generate_incident_id(category, lng, lat, timestamp, grouping_distance)
        id1 = generate_incident_id("MILITARY", 30.5234, 50.4501, "2026-01-21T12:00:00Z", 50.0)
        id2 = generate_incident_id("MILITARY", 30.5234, 50.4501, "2026-01-21T12:00:00Z", 50.0)
        assert id1 == id2
    ...
    def test_different_categories_different_ids(self):
        ...
        id1 = generate_incident_id("MILITARY", 30.5234, 50.4501, "2026-01-21T12:00:00Z", 50.0)
        id2 = generate_incident_id("DIPLOMACY", 30.5234, 50.4501, "2026-01-21T12:00:00Z", 50.0)
        assert id1 != id2
    ...
    def test_different_locations_different_ids(self):
        ...
        # Kyiv coordinates - using 1.0 degree grouping (~111km at equator)
        id1 = generate_incident_id("MILITARY", 30.5234, 50.4501, "2026-01-21T12:00:00Z", 1.0)
        # Moscow coordinates (significantly different - ~7 degrees apart)
        id2 = generate_incident_id("MILITARY", 37.6173, 55.7558, "2026-01-21T12:00:00Z", 1.0)
        assert id1 != id2

    def test_source_id_deterministic(self):
        """Source ID should be deterministic based on content."""
        from argus.utils.hashing import generate_source_id
...
@pytest.mark.skip(reason="Function moved from main.py - tested via integration")
class TestFindSimilarEvent:
    ...
    def test_finds_same_category_and_location(self):
        ...
        from argus.main import _find_similar_existing_event
