...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signOut = useCallback(async () => {
    ...
    // Clear inbox localStorage to prevent stale data on re-login
    if (typeof window !== "undefined") {
      localStorage.removeItem("realpolitik_notification_inbox");
      localStorage.removeItem("realpolitik_inbox_processed");
    }
  }, [supabase]);
